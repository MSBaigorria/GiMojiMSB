...
import SelecData from "./components/ui/SelecData";
        ...
        <div className="row py-lg-5">
          <div className="col-lg-6 col-md-8 mx-auto">
            ...
            <p className="lead text-white">
              Busca y copia y pega los mejores gif y emojis para compartir en
              tus redes o proyectos.
            </p>
          </div>
        </div>
      </section>
      <SelecData categoriesData={catagories} />
